import { MdAccountTree, MdLayers, MdBusiness } from "react-icons/md";
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className={`inline-block px-3 py-1 text-xs rounded-full ${subdepartment.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
