...
import { useDeleteSubdepartmentMutation, useGetSubdepartmentsByDepartmentQuery } from "../../../redux/api/authApi";
        ...
        <div className="border-t border-gray-200 px-6 py-5 bg-white">
          ...
          <div className="space-y-3">
            {subdepartments.length === 0 ? (
              <p className="text-center text-gray-500 py-8">No subdepartments found</p>
            ) : (
              subdepartments.map((subdept) => (
                ...
                >
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900">{subdept.name}</h3>
                    <p className="text-sm text-gray-500">Courses: {subdept.allowedCourses?.length || 0}</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className={`inline-block px-3 py-1 text-xs rounded-full ${
