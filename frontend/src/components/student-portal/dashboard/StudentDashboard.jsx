                ...
                <div className="space-y-4">
                    <div className="p-4 bg-blue-50/50 border border-dashed border-blue-200 rounded-2xl">
                        ...
                        <div className="flex gap-2">
                            <input type="file" className="hidden" id="extra-file-up-dash" onChange={async (e)=>{
                            ...
                            <label htmlFor="extra-file-up-dash" className="flex-1 px-4 py-2 bg-blue-600 text-white text-[10px] font-bold rounded-xl text-center cursor-pointer hover:bg-blue-700 transition uppercase tracking-widest">Select & Upload</label>
                        </div>
                    </div>
                    {(raw.documents||[]).filter(d=>d.isExtra).map((doc, i) => (
